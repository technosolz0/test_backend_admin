...
@router.get("/{address_id}", response_model=user_address_schema.UserAddressOut)
...
@router.put("/{address_id}", response_model=user_address_schema.UserAddressOut)
...
@router.post("/{address_id}/set-default", response_model=user_address_schema.UserAddressOut)
